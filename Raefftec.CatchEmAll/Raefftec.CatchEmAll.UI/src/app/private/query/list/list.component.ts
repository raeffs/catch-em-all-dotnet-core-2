...
import { QuerySummary } from '../../../shared/types/query.class';
...
export class ListComponent {
    ...
    public model: BehaviorSubject<PaginationHelper<QuerySummary>> = new BehaviorSubject<PaginationHelper<QuerySummary>>(new PaginationHelper());
    ...
    public select(item: QuerySummary, event: Event) {
    ...
    public deleteSelected(): void {
        ...
        Observable.of(...ids).pipe(
            mergeMap(x => this.http.delete(`/api/query/${x}`)),
    ...
    private loadPage(page: number): void {
        this.isProcessing = true;
        this.http.get<Page<QuerySummary>>('/api/query', { params: { page: page.toString() } })
            .subscribe(model => {
